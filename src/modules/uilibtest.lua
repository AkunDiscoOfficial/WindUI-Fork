--[[
    ...
    AkunDisco: Whatchu on, i modified this to match my keysystem
...
local x,ajz=h("Enter Key","key",nil,"Input",function(x)
p=x
end)
...
if type(i.KeySystem.URL) ~= "function" then
setclipboard(i.KeySystem.URL)
else
i.KeySystem.URL(x,ajz)
end
end,"Secondary",z.Frame)
end

local C=g("Check Key","arrow-right",function()
local C=p
local D
if type(i.KeySystem.Key)=="function"then
i.KeySystem.Key(C, "bck")
end

if NJqbTxbKnwnxyOqodn == true then
o:Close()()

if i.KeySystem.SaveKey then
writefile(ZBYJwNz,tostring(C))
end
...
if isfile(ZBYJwNz)then
local file=readfile(ZBYJwNz)
if type(e.KeySystem.Key)=="function"then
e.KeySystem.Key(file, "ack")
end
if NJqbTxbKnwnxyOqodn == true then
h=true
else
